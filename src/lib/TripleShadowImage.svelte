...
<style>
    ...
    .triple-shadow-animate:hover > div {
        top: -10px;
        left: -10px;
        /* filter:
            drop-shadow(15px 15px var(--amber-400))
            drop-shadow(15px 15px var(--emerald-200)); */
        box-shadow: 8px 8px var(--amber-400), 16px 16px var(--emerald-200);
    }
</style>