...
<div class="w-full my-12 grid grid-cols-1 gap-y-10 lg:gap-y-32 justify-items-center">
    <div class="grid grid-cols-1 gap-4">
        <span class="lg:pe-96 font-nabla font-normal text-8xl md:text-9xl lg:text-[10rem] xl:text-[14rem] text-white text-outline text-center text-triple-shadow">
            ALEXSEY
        </span>
        <span class="lg:ps-96 font-nabla font-normal text-8xl md:text-9xl lg:text-[10rem] xl:text-[14rem] text-white text-outline text-center text-triple-shadow">
            DACOSTA
        </span>
    </div>
    ...
    <div class="grid grid-cols-2 grid-rows-2 lg:grid-cols-10 lg:grid-rows-7 gap-10 lg:gap-x-10 lg:gap-y-0 justify-items-center lg:w-full lg:px-20">
        <a href="{`${base}/portfolio`}" class="grid lg:grid-rows-8 justify-items-center gap-y-4 lg:col-span-6 lg:row-span-5 lg:w-full lg:h-full">
        ...
        <a href="{`${base}/about-me`}" class="grid lg:grid-rows-5 justify-items-center gap-y-4 lg:col-span-4 lg:row-span-4 lg:w-full lg:h-full">
        ...
        <a href="{`${base}/projects`}" class="grid lg:grid-rows-4 col-span-2 justify-items-center gap-y-4 lg:col-span-3 lg:row-span-3 lg:w-full lg:h-full">
