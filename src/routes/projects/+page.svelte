...
<div class="my-8 grid justify-items-center">
    <Popout text={"projects"} size={"6xl"}/>
</div>
<div class="grid grid-cols-2 gap-10 m-5 md:grid md:grid-cols-4">
    <a href="/projects/botanical-gardens" class="grid grid-rows-2 gap-6 max-h-80 justify-items-center">
    ...
    <a href="/projects/environmental-riso" class="grid grid-rows-2 gap-6 max-h-80 justify-items-center">
        <div class="p-4 rounded-xl triple-shadow">
